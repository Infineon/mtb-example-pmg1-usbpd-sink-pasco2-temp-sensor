...
* File Name: app.c
*
* Description: This is source code for the PMG1 MCU USBPD Sink PAS CO2 and
*              Temperature Sensor Code Example. This file implements functions
*              for handling of PDStack event callbacks and power saving.
*
