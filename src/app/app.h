...
* File Name: app.h
*
* Description: This is header file for the PMG1 MCU USBPD Sink PAS CO2 and
*              Temperature Sensor Code Example. This file defines data
*              structures and function prototypes associated with application
*              level management of the USB-C Port.
*
