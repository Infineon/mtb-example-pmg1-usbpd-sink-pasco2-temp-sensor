...
* File Name: vdm.c
*
* Description: This source file implements handlers for Vendor Defined Messages
*              (VDMs) as part of the PMG1 MCU USBPD Sink PAS CO2 and Temperature
*              Sensor Code Example for ModusToolBox.
*
